...
BLOG_AUTHOR = "Yen3"  # (translatable)
BLOG_TITLE = "Yen3's note"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://yen3.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://yen3.github.io/"
BLOG_EMAIL = "yen3rc@gmail.com"
BLOG_DESCRIPTION = "Let's see how far we can go."  # (translatable)
